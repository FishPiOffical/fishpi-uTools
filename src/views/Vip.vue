            ...
            <div class="hero-text">
                ...
                <div class="hero-cards">
                    <article v-for="tier in vipTiers" :key="tier.id" class="hero-card">
                        ...
                        <button class="btn" :class="{ disabled: currentUserVipInfo&&currentUserVipInfo.state !== 0 }" @click="purchaseTier(tier)">
        ...
        <section class="vip-status-card" v-if="currentUserVipInfo && currentUserVipInfo.state !== 0">
            ...
            <div class="status-actions">
                ...
                <div class="nickname-preview"
                    :class="[`${previewEffect}`, { bold: isBold, underline: hasUnderline }]"
